        ...
        <div className="container py-md-5">
          ...
          <div className="single-w3pvt-page mt-md-5 mt-4 px-lg-5">
            <div className="content-sing-w3ls px-lg-5">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod magna.
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit, Sed diam nonummy nibh euismod magna.
                Integer pulvinar leo id viverra feugiat. Pellentesque Libero Justo, Semper At Tempus Vel,
                Ultrices In Sed Ligula. Nulla Uter Sollicitudin Velit.
              </p>
              <p className="mt-3">
                Integer pulvinar leo id viverra feugiat. Pellentesque Libero Justo, Semper At Tempus Vel,
            ...
            <div className="row my-lg-5 mt-3 mx-0">
              <div className="col-lg-6 text-info pl-0">
                <p>
                  ...
                  Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Vivamus suscipit tortor
                  eget felis porttitor volutpat. Quisque velit nisi, pretium ut lacinia in, elementum id enim.
                  Vivamus suscipit tortor eget felis porttitor elementum id enim volutpat...
                </p>
              </div>
