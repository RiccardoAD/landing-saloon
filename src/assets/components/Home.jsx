        ...
        <div className="container py-md-5">
          ...
          <div className="info-w3pvt-mid text-center px-lg-5">
            <div className="title-desc text-center px-lg-5">
              ...
              <Link to="/services" className="btn mt-lg-4 mt-3 read scroll" role="button">
                Learn More
              </Link>
            </div>
          </div>
        ...
        <div className="container py-md-5">
          ...
          <div className="row ab-info">
            <div className="col-md-6 ab-content ab-content1">
              <div className="ab-content-inner">
                <Link to="/single">
                  <img src="assets/images/services2.jpg" alt="news image" className="img-fluid" />
                </Link>
                <div className="ab-info-con">
                  <h4>Trim your Hair</h4>
                  <Link to="/single" className="read-more two btn m-0 px-3" role="button">
            ...
            <div className="col-md-6 ab-content ab-content1">
              <div className="ab-content-inner">
                <Link to="/single">
                  <img src="assets/images/services1.jpg" alt="news image" className="img-fluid" />
                </Link>
                <div className="ab-info-con">
                  <h4>Trim your Beard</h4>
                  <a href="single.html" className="read-more two btn m-0 px-3">
                    <span className="fa fa-arrow-circle-o-right"></span>
                  </a>
                </div>
              </div>
          ...
          <div className="row ab-info second mt-lg-4">
            <div className="col-md-3 ab-content">
              <div className="ab-content-inner">
                <Link to="/single">
                  <img src="assets/images/ser3.jpg" alt="news image" className="img-fluid" />
                </Link>
                <div className="ab-info-con">
                  <h4>colouring</h4>
                  <a href="single.html" className="read-more two btn m-0 px-3">
            ...
            <div className="col-md-3 ab-content">
              <div className="ab-content-inner">
                <Link to="/single">
                  <img src="assets/images/ser4.jpg" alt="news image" className="img-fluid" />
                </Link>
                <div className="ab-info-con">
                  <h4>Bathing</h4>
                  <a href="single.html" className="read-more two btn m-0 px-3">
            ...
            <div className="col-md-3 ab-content">
              <div className="ab-content-inner">
                <Link to="/single">
                  <img src="assets/images/ser5.jpg" alt="news image" className="img-fluid" />
                </Link>
                <div className="ab-info-con">
                  <h4>drying</h4>
                  <a href="single.html" className="read-more two btn m-0 px-3">
            ...
            <div className="col-md-3 ab-content">
              <div className="ab-content-inner">
                <Link to="/single">
                  <img src="assets/images/ser6.jpg" alt="news image" className="img-fluid" />
                </Link>
                <div className="ab-info-con">
                  <h4>Creams</h4>
                  <a href="single.html" className="read-more two btn m-0 px-3">
          ...
          <div className="row mt-3">
            <div className="col-md-4 test-grid text-left px-lg-3">
              <div className="test-info">
                <p>
                  Lorem Ipsum has been the industry's standard since the 1500s. Praesent ullamcorper dui turpis.
                </p>
